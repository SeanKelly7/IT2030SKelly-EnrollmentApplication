...
namespace EnrollmentApplication.Controllers
{
    public class EnrollmentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EnrollmentId,StudentId,CourseId,Grade,IsActive,AssignedCampus,EnrollmentYear,EnrollmentSemester")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentId,StudentId,CourseId,Grade,IsActive,AssignedCampus,EnrollmentYear,EnrollmentSemester")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
