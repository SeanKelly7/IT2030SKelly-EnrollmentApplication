...
namespace EnrollmentApplication.Controllers
{
    public class EnrollmentController : Controller
    {
		...
		public ActionResult CourseSearch(string l)
		{
			var courses = GetCourses(l);
        ...
        public ActionResult Create([Bind(Include = "EnrollmentId,StudentId,CourseId,Grade,IsActive,AssignedCampus,EnrollmentYear,EnrollmentSemester,Address1,Address2,City,State,Zipcode,Notes")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentId,StudentId,CourseId,Grade,IsActive,AssignedCampus,EnrollmentYear,EnrollmentSemester,Address1,Address2,City,State,Zipcode,Notes,")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
